...
<body>
    <nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
        <div class="container">
            ...
            <!-- super-admin/sa-rfa-entries.php -->
            ...
            <table class="table table-bordered" style="border: 2px solid black; table-layout: fixed;">
                ...
                <tbody>
                    <tr>
                        ...
                        <td class="d-flex align-items-center justify-content-center"><a href="sa-rfa-assignment.php"><button class="btn btn-dark" style="width:55px; height: 45px"><img src="../assets/Done.svg"></button>
                            </a>
                        </td>
                    </tr>
                    <tr>
