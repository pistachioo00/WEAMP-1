        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse navbar-center" id="navbarSupportedContent">
                <ul class="nav nav-underline navbar-nav mx-auto mb-2 mb-lg-0 justify-content-center">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="../super-admin/sa-sena-records.php" id="recordsLink" data-bs-toggle="popover" data-bs-html="true" data-bs-trigger="click" data-bs-title="<strong>SENA Conference</strong>" data-bs-content="Advice Counselling" data-bs-placement="bottom">Records</a>
                    </li>
                    <div class="mr-5"></div>
                    <li>
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body modal-dialog-scrollable">
                    <h2 class="text-start" style="font-family: sub-font-bold; font-weight: bold">SENA CONFERENCE
                    </h2>
                    <h3 class="text-start" style="font-family: sub-font; padding-bottom: 5%">Details</h3>

                    <h4 class="text-start fw-bold mt-5" style="font-family: sub-font; color: black;">Reference No.
                    </h4>
                    <h2 class="fw-bold text-start" style="font-family: Arial; color: black">SEAD
                    ...
                    <div class="checkbox-container">
                        ...
                        <div class="sena-rec-checkboxes">
                            ...
                            <label for="checkbox1" style=" margin-left: 3%"><span style="font-weight: bold; font-size: 1rem">Advice and Counseling</span></label>
                        </div>
                        <hr class="my-2" style="border-top: 2px solid #367AFF;">
                        <!-- Checkbox 2 -->
                        <div class="sena-rec-checkboxes">
                            <input type="checkbox" id="checkbox2" onchange="toggleDiv()">
                            <label for="checkbox2" style=" margin-left: 3%"><span style="font-family: Arial; font-weight: bold; font-size: 1rem;">Set Joint
                        ...
                        <div id="additional-info" style="display: none;">
                            ...
                            <div id="originalContent">
                                <h5 class="fw-bold text-start" style="font-family: Arial; color: black; padding-top: 5%">Minutes of the
                                    Conference</h5>
                                ...
                                <div class="container" id="originalContainer" style="display: flex; align-items: center; margin-top: 10px;">
                                    <div id="output" style="flex: 1; background-color: #E5EEFF; border-radius: 5px; border: 2px solid black;" contenteditable="true"></div>
                                    <button class="image-button" style="height: 15px; width: 15px; border-radius:20%; margin-left: 10px;" onclick="cloneContainer()">
                    ...
                    <div class="sena-rec-checkboxes" style="margin-right: 5px;">
                        ...
                        <label for="checkbox3" style=" margin-left: 3%"><span style="font-family: Arial; font-weight: bold; font-size: 1rem;">Settlement
                    ...
                    <div class="sena-rec-checkboxes">
                        ...
                        <label for="checkbox4" style=" margin-left: 3%"><span style="font-family: Arial; font-weight: bold; font-size: 1rem">Withdrawal</span></label>
                    </div>
                    <hr class="my-2" style="border-top: 2px solid #367AFF;">
                    ...
                    <div class="sena-rec-checkboxes">
                        ...
                        <label for="checkbox5" style=" margin-left: 3%"><span style="font-family: Arial; font-weight: bold; font-size: 1rem;">Referral</span></label>
                    </div>

                    <div class="mb-3">
                        <label for="exampleFormControlTextarea1" class="form-label" style="font-weight:bold">Remarks</label>
                        <textarea class="form-control" id="exampleFormControlTextarea1" rows="4"></textarea>
                    </div>

                    <div class="modal-footer" style="border-top: 3px solid #757575;">
                        <button type="button" class="btn btn-success" data-bs-dismiss="modal" id="detailSave">Save
                            changes</button>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary" data-bs-dismiss="modal"><a class="nav-link" href="../super-admin/sa-sena-records.php" id="deleteRow">Delete</button></a>
                    <button type="button" class="btn btn-secondary"><a class="nav-link" href="../super-admin/sa-sena-records.php">Close</button></a>
                </div>
            </div>
        </div>
        ...
        <table class="table-sena-records" style="padding-bottom: 20%;">
            ...
            <tbody>
                <tr style="background-color:#E5EEFF">
                    ...
                    <td>
                        <div class="button-container">
                            <a href="sa-sena-details.php"><button class="button col-md-3" data-bs-toggle="modal" data-bs-target="#exampleModal"><img src="../assets/info.svg" alt=""></a></button>
                ...
                <tr>
                    ...
                    <td>
                        <div class="button-container">
                            <a href="sa-sena-details2.php"><button class="button col-md-3" data-bs-toggle="modal" data-bs-target="#exampleModal"><img src="../assets/info.svg" alt=""></a></button>
                            <button class="button col-md-3" data-bs-toggle="modal" data-bs-target="#exampleModal2"><img src="../assets/pencil--change-edit-modify-pencil-write-writing.svg" alt=""></button>
                            <button class="button col-auto"><img src="../assets/import.svg" alt=""></button>
                            <button class="button col-md-3" data-bs-toggle="modal" data-bs-target="#exampleModal4"><img src="../assets/trash.svg" alt=""></button>
                        </div>
