                        ...
                        <div class="modal-body">
                            <div class="container text-align-left">
                                ...
                                <div class="modal-footer">
                                    <a class="nav-link" href="sa-update-account.php"><button type="button" class="btn btn-success">Change Password</a></button>
                ...
                <form action="process.php" method="POST">
                    ...
                    <div class="mb-3 row">
                        <div class="col-sm-4 mt-4">
                            <a class="nav-link" href="../super-admin/sa-update-account.php"><button type="submit" style="font-family: sub-font-bold; width: 100%;" class="btn btn-dark btn-sm rounded-pill text-white">Update Account</button></a>
                        </div>
                    </div>
                </form>
