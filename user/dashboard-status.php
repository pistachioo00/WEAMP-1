...
<body>
    ...
    <section class="my-account-sec">
        <div class="container text-center">
            <h4 class="display-6 mt-2" style="font-family: sub-font-bold; padding-top: 15%;">RFA Status<br><br></h4>
        </div>
    </section>

    <div class="container d-flex justify-content-center align-items-center mt-3" style="padding-bottom: 15%;">
